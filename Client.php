<?php 
    ...
    if(!isset($_SESSION['email']) && !isset( $_SESSION['password'])){
        ...
        if (isset($_POST['add'])){
            ...
            $idp=htmlspecialchars($_POST['product_id']);
        ...
        if(isset($_POST['view'])){
            $_SESSION['id-produit']=htmlspecialchars($_POST['product_id']);
            ...
            <body>
                <div id="conteneur-global">
                    ...
                    <section id="sec1new">
                        ...
                        <a href="promotions.php">voir plus de promotions</a>
                    </section>
                            ...
                            while($row=$result->fetch()){
                                ...
                                if($z<=28){
                                    ...
                                    if($nbligne==0){
                                        if($i >=4){
                                            echo'<br><br>';
                                            getProduct($row['LIBELLE'],$row['PRIX_VENTE'],$row['MARQUE'],$row['IMAGE'],$row['ID_PRODUIT'],$z);
                                            $i=1;
                                            $haut+=14.4;
                                            $espace=60;
                                        }else{
                                        ...
                                        if($i >=4){
                                            echo'<br><br>';
                                            getProduct_Promotion($row['LIBELLE'],$row['PRIX_VENTE'],$l['PRIX'],$row['MARQUE'],$row['IMAGE'],$row['ID_PRODUIT'],$z);
                                            $i=1;
                                            $haut+=14.4;
                                            $espace=60;
                                        }else{
                        ...
                        <div class="commande-class">
                            <a href="commande.php">
                                ...
                                <?php
                                    $count  = countCommande();
                                    ?>
                                    <span class="cmd-count"><?php echo $count ?></span>
                                    <?php
                                ?>
                            </a>
                        </div>
                    ...
                    <footer>
                        ...
                        <table class="tab1">
                            ...
                            <tbody>
                                <tr><td><a href="infos.php#sec1" style="text-decoration: none;">Contactez-nous</a></td></tr>
                                <tr><td><a href="infos.php#sec2" style="text-decoration: none;">Politique de retour</a></td></tr>
                                <tr><td><a href="infos.php#sec3" style="text-decoration: none;">Signaler un produit</a></td></tr>
                            </tbody>
                        </table>
                        <table class="tab2">
                            <thead><tr><td>Apropos du magasin</td></tr></thead>
                            <tbody>
                                <tr><td><a href="About.php" style="text-decoration: none;">Qui sommes-nous?</a></td></tr>
                            </tbody>
                        </table>
                        <pre>
